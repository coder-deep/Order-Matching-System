...
public class Trade_logService implements ITrade_logService {
	...
	@Override
	public double getBuyTotalByClient(String id)
	{
		return tlrep.getBuyTotalByClient(id);
	}
	@Override
	public double getSellTotalByClient(String id)
	{
		return tlrep.getSellTotalByClient(id);
	}
	@Override
	public void save(Trade_log t) 
	{
		tlrep.save(t);
	}
}
